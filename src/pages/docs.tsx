...
//   let x = 0;
//   console.log(maps.get(item.category), "ssss");

//   const y = item.category * 20;
//   item.x = x;
//   item.y = y;
// });
...
const DocsPage = () => {
  useEffect(() => {
    ...
    // 绘制图表
    data.nodes.forEach(function (node: GraphNode) {
      node.label = {
  ...
  return (
    <div>
      <div id="chart" style={{ width: "100%", height: 600 }} />
    </div>
  );
};
